! function() {
  ...
  for (var r = window.console = window.console || {}; n--;) e = o[n], r[e] || (r[e] = t)
    ...
    angular.module("Controllers")
      .controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", function(e, t, o, n) {
        $(".lang .lang-item")
          .click(function(e) {
            $("script")
              .remove(), location.href = e.target.href, e.preventDefault()
          }), window.MMCgi.isLogin || t.getUUID()
          .then(function(r) {
            function a(i) {
              switch (i.code) {
                case 200:
                  t.newLoginPage(i.redirect_uri)
                    .then(function(t) {
            ...
            o.log("login", r), e.uuid = r, e.qrcodeUrl = "https://login.weixin.qq.com/qrcode/" + r, e.code = 0, e.isScan = !1, e.isIPad = o.isIPad, e.isMacOS = o.isMacOS, e.isWindows = o.isWindows, e.lang = o.queryParser()
              .lang || "zh_CN";
            var i = !1;
            n.report(n.ReportType.timing, {
              ...
              }, window.MMCgi.isLogin || t.checkLogin(r, 1)
              .then(a)
          })
      }])
  }(), ! function() {
          ...
          e.delState = !1, e.chatContent = [], e.isShowChatRoomMembers = !1, $(w)
            .on("drop", function() {
                    ...
                    switch (o.AppMsgType) {
                      case u.APPMSGTYPE_ATTACH:
                        a.MMAppMsgDownloadUrl = a.MMAppMsgDownloadUrl.replace("#MediaId#", o.MediaId)
                          .replace("mediaid=undefined", "mediaid=" + o.MediaId)
                    }
              ...
              d - t.pageX < l && (C = t.pageX - l), p - t.pageY < f && (h = t.pageY - f), g.open({
                ...
                , singletonId: "mmpop_profile"
                , controller: ["$scope", function(e) {
                  e.contact = a, e.MMDefaultRemark = MM.context("8d521cc"), e.addUserContent = MM.context("5a97440") + y.formatHTMLToSend(c.getUserInfo()
                    .NickName), e.isShowSendBox = r || !1, e.chat = function(t) {
                    o.go("chat", {
                      userName: t
                    }), e.closeThisMmPop()
                    ...
                    return t && -1 === [8, 37, 39, 46, 13].indexOf(t.keyCode) && r > 13 ? void t.preventDefault() : void(t && 13 != t.keyCode || (n.length > 17 && (n = n.substring(0, 18)), e.editing = !1, e.contact.RemarkName = n, M({
                      ...
                      .error(function() {}), $('<div contenteditable="true"></div>')
                      .appendTo("body")
                      .focus()
                      .remove()))
                ...
                setTimeout(function() {
                  ...
                  if (n.MsgType == u.MSGTYPE_EMOTICON || n.MsgType == u.MSGTYPE_IMAGE || n.MsgType == u.MSGTYPE_VIDEO) {
                    ...
                    var c = o.find(".content .msg-img")
                      , s = c.height()
                      , l = {};
                    if (console.log("preload!!!!!!!!!!!!!!!!!!!", n, s > 40 || 1 == c[0].complete && !(0 === c[0].naturalWidth) && s > 0, n.ImgHeight), n.ImgHeight) n.MsgType == u.MSGTYPE_EMOTICON ? (l.height = n.ImgHeight * c.width() / n.ImgWidth +
                      "px", l.widht = c.width() + "px") : (l.height = n.ImgHeight, l.width = n.ImgWidth), n.MMImgStyle = l, t.$digest(), r(o.height()), t.$destroy(), o.remove();
    ...
    angular.module("Controllers")
      .controller("chatSenderController", ["$rootScope", "$scope", "$http", "$timeout", "ngDialog", "confFactory", "accountFactory", "contactFactory", "chatFactory", "screenShotFactory", "utilFactory", "mmpop", "stateManageService", "emojiFactory"
        ...
        , function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
          ...
          function y() {
            var e, t;
            document.createRange ? (e = document.createRange(), e.selectNodeContents(D), e.collapse(!1), t = window.getSelection(), t.removeAllRanges(), t.addRange(e)) : document.selection && (e = document.body.createTextRange(), e.moveToElementText(
              D), e.collapse(!1), e.select())
          }

          function C(e) {
            var t, o, n = "";
            if (window.getSelection) t = window.getSelection(), t.rangeCount > 0 && (o = t.getRangeAt(0)
              .cloneRange(), o.collapse(!0), o.setStart(D, 0), n = o.toString()
              .slice(-e));
          ...
          $(D)
            ...
            }), t.isDisabled = !t.userName, t.isMacOS = navigator.userAgent.toUpperCase()
            .indexOf("MAC OS") > -1, t.editAreaCtn = "";
          var L;
    ...
    "use strict";
    angular.module("Controllers")
      .controller("emojiController", ["$rootScope", "$scope", "$timeout", "emojiFactory", "confFactory", "utilFactory", function(e, t, o, n, r, a) {
        o(function() {
    ...
    "use strict";
    angular.module("Controllers")
      .controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function(e, t, o, n
        , r, a, i, c, s, l, u, f) {
        function d(e) {
          function o(e) {
                ...
                , controller: ["$scope", function(e) {
                  e.keypress = function(e) {
                    var t = $(".chatroom_topic .chatroom_name")
                      .text()
                      .length; - 1 === [8, 37, 39, 46].indexOf(e.keyCode) && t > 17 && e.preventDefault()
    ...
    "use strict";
    angular.module("Controllers")
      .controller("editAreaContactListController", ["$scope", "confFactory", "utilFactory", "$timeout", function(e, t, o) {
        function n(t, n) {
    ...
    "use strict";
    angular.module("Controllers")
      .controller("systemMenuController", ["$rootScope", "$scope", "$timeout", "ngDialog", "loginFactory", "confFactory", "accountFactory", "utilFactory", "oplogFactory", function(e, t, o, n, r, a, i, c, s) {
    ...
    "use strict";
    angular.module("Controllers")
      .controller("readMenuController", ["$rootScope", "$scope", "subscribeMsgService", function(e, t, o) {
    ...
    angular.module("Services")
      .factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function(e, t, o, n, r, a, i, c) {
        var s = {
          globalData: {
            chatList: []
          }
          ...
          , syncCheck: function() {
            var e = t.defer()
              , c = this
              , s = o.API_synccheck + "?" + ["r=" + a.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncCheckKey())]
              .join("&");
            return window.synccheck && (window.synccheck.selector = 0), $.ajax({
              ...
              .done(function() {
                window.synccheck && "0" == window.synccheck.retcode ? "0" != window.synccheck.selector ? c.sync()
                  ...
                  }) : e.reject(window.synccheck && window.synccheck.selector) : !window.synccheck || "1101" != window.synccheck.retcode && "1102" != window.synccheck.retcode ? window.synccheck && "1100" == window.synccheck.retcode ? r.loginout(
                    0) : (e.reject("syncCheck net error"), i.report(i.ReportType.netError, {
    ...
    "use strict";
    angular.module("Services")
      .factory("chatFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "notificationFactory", "utilFactory", "reportService", "mmHttp", "titleRemind", function($rootScope, $timeout
        , $http, $q, contactFactory, accountFactory, emojiFactory, confFactory, notificationFactory, utilFactory, reportService, mmHttp, titleRemind) {
        ...
        var _chatList = []
          ...
          , _sendFileUserName, service = {
            ...
            , _sendCheck: function(e) {
              var t = $("#chatArea .title_wrap .title_name")
                .eq(0)
                , o = $(".chat_list .chat_item.active")
                .eq(0);
              if (t && o) {
                var n = t.attr("data-username")
                  , r = o.attr("data-username");
                return console.log(e, n, r), n == r && r == e ? !0 : !1
              }
              return !1
            }
              ...
              switch (e.FromUserName || (e.FromUserName = accountFactory.getUserName()), e.ToUserName || (e.ToUserName = this.getCurrentUserName()), e.isTranspond || this._sendCheck(e.ToUserName) || (utilFactory.reportSendState("uiCheckFail")
                ...
                case confFactory.MSGTYPE_APP:
                  e.AppMsgType = confFactory.APPMSGTYPE_ATTACH, e.Content = "<msg><appmsg appid='wxeb7ec651dd0aefa9' sdkver=''><title>" + e.FileName + "</title><des></des><action></action><type>" + confFactory.APPMSGTYPE_ATTACH +
                    "</type><content></content><url></url><lowurl></lowurl><appattach><totallen>" + e.FileSize + "</totallen><attachid>#MediaId#</attachid><fileext>" + e.MMFileExt + "</fileext></appattach><extinfo></extinfo></appmsg></msg>"
              }
              return e
            }
            ...
            , postTextMessage: function(e) {
              ...
              e.MMAtContacts && e.MMAtContacts.length && (t.MsgSource = "<msgsource><atusername>" + e.MMAtContacts + "</atusername><atchatroomname>" + e.ToUserName + "</atchatroomname></msgsource>"), this._postMessage(confFactory.API_webwxsendmsg
                , t, e)
            }
            ...
            , postAppMessage: function(e) {
              var t = {
                ...
                , Content: "<appmsg appid='wxeb7ec651dd0aefa9' sdkver=''><title>" + e.FileName + "</title><des></des><action></action><type>" + confFactory.APPMSGTYPE_ATTACH +
                  "</type><content></content><url></url><lowurl></lowurl><appattach><totallen>" + e.FileSize + "</totallen><attachid>" + e.MediaId + "</attachid><fileext>" + e.MMFileExt + "</fileext></appattach><extinfo></extinfo></appmsg>"
              };
            ...
            , addChatList: function(e) {
              ...
              e && (angular.isArray(e) || (e = [e]), angular.forEach(e, function(e) {
                var t = ""
                  , o = 0;
                if (t = e.UserName ? e.UserName : e.FromUserName == accountFactory.getUserInfo()
                  .UserName ? e.ToUserName : e.FromUserName, o = _chatList.indexOf(t), -1 == o) _chatList.unshift(t), utilFactory.isRoomContact(t) && contactFactory.addBatchgetChatroomContact(t);
                else {
            ...
            , messageProcess: function(e) {
              ...
              if (!o || o.isMuted() || o.isSelf() || o.isShieldUser() || o.isBrandContact() || titleRemind.increaseUnreadMsgNum(), e.MMPeerUserName = t._getMessagePeerUserName(e), e.MsgType == confFactory.MSGTYPE_STATUSNOTIFY) return void t._statusNotifyProcessor(
                e);
              if (e.MsgType == confFactory.MSGTYPE_SYSNOTICE) return void console.log("MSGTYPE_SYSNOTICE", e.Content);
              if (!(utilFactory.isShieldUser(e.FromUserName) || utilFactory.isShieldUser(e.ToUserName) || e.MsgType == confFactory.MSGTYPE_VERIFYMSG && e.RecommendInfo && e.RecommendInfo.UserName == accountFactory.getUserInfo()
                  .UserName)) {
                switch (t._commonMsgProcess(e), e.MsgType) {
                  ...
                  case confFactory.MSGTYPE_MICROVIDEO:
                    ...
                    break;
                  case confFactory.MSGTYPE_TEXT:
                    "newsapp" == e.FromUserName ? t._newsMsgProcess(e) : e.AppMsgType == confFactory.APPMSGTYPE_RED_ENVELOPES ? (e.MsgType = confFactory.MSGTYPE_APP, t._appMsgProcess(e)) : e.SubMsgType == confFactory.MSGTYPE_LOCATION ? t._locationMsgProcess(
                ...
                e.MMIsSend || r && (r.isMuted() || r.isBrandContact()) || e.MsgType == confFactory.MSGTYPE_SYS || (accountFactory.isNotifyOpen() && t._notify(e), accountFactory.isSoundOpen() && utilFactory.initMsgNoticePlayer(confFactory.RES_SOUND_RECEIVE_MSG))
                  , t.addChatMessage(e), t.addChatList([e])
              }
            }
            ...
            , _commonMsgProcess: function(e) {
              var t, o, n = this
                ...
                , a = ""
                , i = "";
              e.Content = e.Content || "", e.MMDigest = "", e.MMIsSend = e.FromUserName == accountFactory.getUserName() || "" == e.FromUserName, o = n.getChatMessage(e.MMPeerUserName), utilFactory.isRoomContact(e.MMPeerUserName) ? (e.MMIsChatRoom = !
                  0, r = e.Content.replace(/^(@[a-zA-Z0-9]+|[a-zA-Z0-9_-]+):<br\/>/, function(e, t) {
                    return a = t, ""
                  }), a && a != accountFactory.getUserName() && (t = contactFactory.getContact(a, e.MMPeerUserName), t && (i = t.getDisplayName(e.MMPeerUserName), i && (e.MMDigest = i + ":")))) : (e.MMIsChatRoom = !1, r = e.Content), e.MMIsSend ||
                e.MMUnread != _aoUndefined || e.MsgType == confFactory.MSGTYPE_SYS || (e.MMUnread = !0), e.LocalID || (e.ClientMsgId = e.LocalID = e.MsgId), r = emojiFactory.emoticonFormat(r), e.MMActualContent = r, e.MMActualSender = a || e.FromUserName
            ...
            , _appUrlMsgProcess: function(e, t) {
              ...
              var o = utilFactory.htmlDecode(e.MMActualContent)
                .replace(/<br\/>/g, "");
            ...
            , _appAttachMsgProcess: function(e) {
              var t = utilFactory.htmlDecode(e.MMActualContent)
                .replace(/<br\/>/g, "");
              t = utilFactory.encodeEmoji(t), t = utilFactory.xml2json(t), e.MMDigest += MM.context("6daeae3"), e.MMFileStatus = e.sendByLocal ? confFactory.MM_SEND_FILE_STATUS_SENDING : confFactory.MM_SEND_FILE_STATUS_SUCCESS, e.MMAppMsgFileExt =
                t.appmsg.appattach.fileext.toLowerCase(), e.MMAppMsgFileSize = utilFactory.getSize(+t.appmsg.appattach.totallen), e.MMAppMsgDownloadUrl = confFactory.API_webwxdownloadmedia + "?sender=" + e.FromUserName + "&mediaid=" + e.MediaId +
                "&filename=" + encodeURIComponent(e.FileName) + "&fromuser=" + accountFactory.getUin() + "&pass_ticket=" + encodeURIComponent(accountFactory.getPassticket()) + "&webwx_data_ticket=" + encodeURIComponent(utilFactory.getCookie(
                  "webwx_data_ticket"))
            }
            ...
            , _recalledMsgProcess: function(e) {
              ...
              if (r = utilFactory.encodeEmoji(r), a = utilFactory.xml2json(r)
                .revokemsg, 0 == a.msgid) {
            ...
            , _systemMsgProcess: function(e) {
              ...
              if (t)
                for (var o, n, r = 0, a = t.length; a > r; ++r) o = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(t[r]), o && o[1] && (n = o[1], e.MMActualContent = e.MMActualContent.replace(
                  /&lt;a href=(?:'|")weixin:\/\/.*?&lt;\/a&gt;/, ""));
              e.MMDigest += e.MMActualContent
            }
            , _notify: function(e) {
              function t() {
                for (var t = contactFactory.getContact(e.MMPeerUserName), o = t ? t.getDisplayName(e.MMPeerUserName) : "", n = t ? t.HeadImgUrl : "", r = e.MMDigest.replace(/(<img.*?\/>)|<span class="emoji.*?<\/span>/g, MM.context("809bb9d"))
                    , a = utilFactory.clearHtmlStr(r), i = "", c = 80, s = 0, l = 0; l < a.length; l++) {
            ...
            , _calcMsgDisplayTime: function(e, t) {
              if (t && !(t.MsgType < 0))
                if (!e || e.MsgType < 0) {
                  ...
                  var o = new Date(1e3 * t.CreateTime);
                  t.MMDigestTime = o.getHours() + ":" + utilFactory.formatNum(o.getMinutes(), 2), Math.abs(e.MMDisplayTime - t.CreateTime) >= 180 ? (t.MMDisplayTime = t.CreateTime, t.MMTime = t.MMDigestTime) : (t.MMDisplayTime = e.MMDisplayTime
                    , t.MMTime = "")
                }
            }
    ...
    "use strict";
    angular.module("Services")
      .factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function(e, t, o, n, r, a, i, c, s, l) {
        var u, f = {}
          , d = {
            ...
            , addMember: function(e, t, o) {
              ...
              n.MemberList.length + t.split(",")
                .length >= 40 ? (console.log("invite", n.MemberList.length + t.split(",")
                  .length), this._update("invitemember", e, {
                  inviteMembers: t
    ...
    "use strict";
    angular.module("Services")
      .factory("accountFactory", ["$q", "confFactory", "utilFactory", function(e, t, o) {
        var n, r, a, i = {}
          , c = null
          , s = null
          , l = {
    ...
    "use strict";
    angular.module("Services")
      .factory("confFactory", ["$q", function() {
        var e = location.host
          , t = "login.weixin.qq.com"
          , o = "file.wx.qq.com"
          , n = "webpush.weixin.qq.com";
        e.indexOf("wx2.qq.com") > -1 ? (t = "login.wx2.qq.com", o = "file.wx2.qq.com", n = "webpush.wx2.qq.com") : e.indexOf("wx8.qq.com") > -1 ? (t = "login.wx8.qq.com", o = "file.wx8.qq.com", n = "webpush.wx8.qq.com") : e.indexOf("qq.com") > -
          1 ? (t = "login.wx.qq.com", o = "file.wx.qq.com", n = "webpush.wx.qq.com") : e.indexOf("web2.wechat.com") > -1 ? (t = "login.web2.wechat.com", o = "file.web2.wechat.com", n = "webpush.web2.wechat.com") : e.indexOf("wechat.com") > -1 &&
          (t = "login.web.wechat.com", o = "file.web.wechat.com", n = "webpush.web.wechat.com");
        var r = navigator.language || navigator.browserLanguage;
        r || (r = "zh-cn"), r = r.split("-"), r = r[0].toLowerCase() + "_" + (r[1] || "")
          .toUpperCase();
        var a = {
          LANG: r
    ...
    "use strict";
    angular.module("Services")
      .factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function(e, t, o, n, r, a, i, c, s, l, u) {
        function f(e) {
        ...
        var d, g = window._contacts = {}
          ...
          , P = {
            ...
            , isInChatroom: function() {
              ...
              return 0 == this.MemberList.length && 0 != this.ContactFlag ? !0 : e.MMInChatroom === !1 || e.MMInChatroom === !0 ? e.MMInChatroom : (angular.forEach(this.MemberList, function(t) {
                return t.UserName == a.getUserInfo()
                  .UserName ? void(e.MMInChatroom = !0) : void 0
            ...
            , canSearch: function(e) {
              ...
              return c = t.toUpperCase()
                .indexOf(e), s = o.toUpperCase()
                .indexOf(e), c >= 0 || s >= 0 ? !0 : (c = n.toUpperCase()
                  .indexOf(e), s = r.toUpperCase()
                  .indexOf(e), c >= 0 || s >= 0 ? !0 : a.toUpperCase()
                  .indexOf(e) >= 0 ? !0 : i.toUpperCase()
                  .indexOf(e) >= 0 ? !0 : !1)
            }
            , update: function(e) {
          ...
          , I = {
            ...
            , addContact: function(e) {
              e && (e.isContact || (e = f(e), e.MMOrderSymbol = this.getContactOrderSymbol(e)), e.EncryChatRoomId && e.UserName && (e.MMFromBatchget = !0), e.RemarkName = e.RemarkName && i.transformSpanToImg(e.RemarkName), e.NickName = e.NickName &&
                i.transformSpanToImg(e.NickName), e.isShieldUser() || !e.isContact() && !e.isRoomContact() ? this.addStrangerContact(e) : this.addFriendContact(e))
            }
    ...
    "use strict";
    angular.module("Services")
      .factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function(e, t, o, n, r, a, i, c) {
        var s = {
          getUUID: function() {
            var e = t.defer();
    ...
    "use strict";
    angular.module("Services")
      .factory("utilFactory", ["$q", "$rootScope", "confFactory", function(e, t, o) {
        function n(e, t, o, n) {
          var r;
        ...
        var r, a = {}
          ...
          , c = ["weibo", "qqmail", "fmessage", "tmessage", "qmessage", "qqsync", "floatbottle", "lbsapp", "shakeapp", "medianote", "qqfriend", "readerapp", "blogapp", "facebookapp", "masssendapp", "meishiapp", "feedsapp", "voip"
        ...
        var u = {
          ...
          , hrefEncode: function(e) {
            ...
            if (o) {
              for (var n, r, a = 0, c = o.length; c > a; ++a) n = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(o[a]), n && n[1] && (r = n[1], t.isUrl(r) && (e = e.replace(n[0], this.htmlDecode(n[0]))
                .replace(n[1], u.genCheckURL(n[1]))));
              return e
            }
    ...
    "use strict";
    angular.module("Services")
      .factory("emojiFactory", ["$http", "$q", "confFactory", "utilFactory", function(e, t, o, n) {
        var r = {
          ...
          , QQFaceList: ["微笑", "撇嘴", "色", "发呆", "得意", "流泪", "害羞", "闭嘴", "睡", "大哭", "尴尬", "发怒", "调皮", "呲牙", "惊讶", "难过", "酷", "冷汗", "抓狂", "吐", "偷笑", "愉快", "白眼", "傲慢", "饥饿", "困", "惊恐", "流汗", "憨笑", "悠闲", "奋斗", "咒骂", "疑问", "嘘", "晕", "疯了", "衰", "骷髅"
            , "敲打", "再见", "擦汗", "抠鼻", "鼓掌", "糗大了", "坏笑", "左哼哼", "右哼哼", "哈欠", "鄙视", "委屈", "快哭了", "阴险", "亲亲", "吓", "可怜", "菜刀", "西瓜", "啤酒", "篮球", "乒乓", "咖啡", "饭", "猪头", "玫瑰", "凋谢", "嘴唇", "爱心", "心碎", "蛋糕", "闪电", "炸弹", "刀", "足球", "瓢虫", "便便", "月亮"
            , "太阳", "礼物", "拥抱", "强", "弱", "握手", "胜利", "抱拳", "勾引", "拳头", "差劲", "爱你", "NO", "OK", "爱情", "飞吻", "跳跳", "发抖", "怄火", "转圈", "磕头", "回头", "跳绳", "投降", "激动", "乱舞", "献吻", "左太极", "右太极"
          ]
          , EmojiList: ["笑脸", "开心", "大笑", "热情", "眨眼", "色", "接吻", "亲吻", "脸红", "露齿笑", "满意", "戏弄", "吐舌", "无语", "得意", "汗", "失望", "低落", "呸", "焦虑", "担心", "震惊", "悔恨", "眼泪", "哭", "破涕为笑", "晕", "恐惧", "心烦", "生气", "睡觉", "生病", "恶魔", "外星人", "心", "心碎", "丘比特"
            , "闪烁", "星星", "叹号", "问号", "睡着", "水滴", "音乐", "火", "便便", "强", "弱", "拳头", "胜利", "上", "下", "右", "左", "第一", "强壮", "吻", "热恋", "男孩", "女孩", "女士", "男士", "天使", "骷髅", "红唇", "太阳", "下雨", "多云", "雪人", "月亮", "闪电", "海浪", "猫", "小狗", "老鼠", "仓鼠"
            , "兔子", "狗", "青蛙", "老虎", "考拉", "熊", "猪", "牛", "野猪", "猴子", "马", "蛇", "鸽子", "鸡", "企鹅", "毛虫", "章鱼", "鱼", "鲸鱼", "海豚", "玫瑰", "花", "棕榈树", "仙人掌", "礼盒", "南瓜灯", "鬼魂", "圣诞老人", "圣诞树", "礼物", "铃", "庆祝", "气球", "CD", "相机", "录像机", "电脑", "电视"
            , "电话", "解锁", "锁", "钥匙", "成交", "灯泡", "邮箱", "浴缸", "钱", "炸弹", "手枪", "药丸", "橄榄球", "篮球", "足球", "棒球", "高尔夫", "奖杯", "入侵者", "唱歌", "吉他", "比基尼", "皇冠", "雨伞", "手提包", "口红", "戒指", "钻石", "咖啡", "啤酒", "干杯", "鸡尾酒", "汉堡", "薯条", "意面", "寿司", "面条"
            , "煎蛋", "冰激凌", "蛋糕", "苹果", "飞机", "火箭", "自行车", "高铁", "警告", "旗", "男人", "女人", "O", "X", "版权", "注册商标", "商标"
          ]
          , QQFaceMap: {
            "微笑": "0"
            , "撇嘴": "1"
    ...
    "use strict";
    angular.module("Services")
      .factory("contextMenuFactory", ["$timeout", "confFactory", function() {
        var e, t = ""
          , o = {
    ...
    angular.module("Services")
      .factory("screenShotFactory", ["confFactory", "reportService", function(e, t) {
        ...
        function a() {
          return o() && r() ? o()
            .SaveClipBoardBmpToFile(1) : !1
        }

        function i(o, r) {
          var i = n();
          i.StopUpload(), i.ClearHeaders(), i.ClearFormItems(), i && (i.URL = (MMDEV ? "http://wx.qq.com" : "http://" + location.hostname) + e.API_webwxpreview + "?fun=upload", i.AddHeader("Cookie", document.cookie), i.AddFormItem(
            "msgimgrequest", 0, 0, o), i.AddFormItem("filename", 1, 4, a()), i.OnEvent = function(e, o) {
            switch (o) {
              case 2:
                break;
              case 3:
    ...
    "use strict";
    angular.module("Services")
      .factory("resourceService", ["$timeout", "$http", "$q", "$window", function(e, t, o, n) {
        function r(t, o, n) {
    ...
    "use strict";
    angular.module("Services")
      .factory("oplogFactory", ["$http", "accountFactory", "confFactory", function(e, t, o) {
        return {
          feedback: function(n) {
            e({
              method: "POST"
    ...
    "use strict";
    angular.module("Services")
      .factory("reportService", ["$http", "$rootScope", "confFactory", "accountFactory", function(e, t, o, n) {
        function r() {
          var e, t = {};
    ...
    "use strict";
    angular.module("Services")
      .factory("mmHttp", ["$http", "$q", "$timeout", function(e, t, o) {
        function n(n) {
          function r(t, n) {
            e[t].apply(e, n)
              .success(i)
    ...
    "use strict";
    angular.module("Services")
      .factory("surviveCheckService", ["$http", "$q", "$timeout", function() {
        var e, t, o = {
          start: function(o) {
    ...
    angular.module("Services")
      .factory("titleRemind", ["$window", function(e) {
        function t(e, t) {
          ...
          var r, a;
          "undefined" != typeof n.hidden ? (r = "hidden", a = "visibilitychange") : "undefined" != typeof n.mozHidden ? (r = "mozHidden", a = "mozvisibilitychange") : "undefined" != typeof n.msHidden ? (r = "msHidden", a = "msvisibilitychange") :
            "undefined" != typeof n.webkitHidden && (r = "webkitHidden", a = "webkitvisibilitychange"), "undefined" == typeof n.addEventListener || "undefined" == typeof r ? ($(window)
              .focus(function() {
                t()
              }), $(window)
              .blur(function() {
    ...
    "use strict";
    angular.module("Services")
      .factory("subscribeMsgService", ["$rootScope", "contactFactory", "accountFactory", "confFactory", "utilFactory", function(e, t, o, n, r) {
        var a = []
          , i = {
            current: null
            , changeFlag: 0
    ...
    angular.module("Directives")
      .directive("messageDirective", ["$timeout", "confFactory", function() {
        return {
          restrict: "A"
  ...
  .directive("mmpopDirective", ["$timeout", "$document", "mmpop", "$animate", function() {
    return {
      restrict: "EA"
      , scope: {}
      , link: function() {}
  ...
  .directive("contenteditableDirective", ["$timeout", "utilFactory", "confFactory", function(e, t, o) {
    return {
      restrict: "A"
      , require: "?ngModel"
        ...
        if (a) {
          ...
          n.bind("paste", function() {
            ...
            s && clearTimeout(s), s = setTimeout(function() {
              for (var c = e.innerHTML, l = -1, u = -1, f = 0, d = c.length; d > f && (-1 == l && r.substr(f, 1) != c.substr(f, 1) && (l = f), -1 == u && r.substr(r.length - f - 1, 1) != c.substr(c.length - f - 1, 1) && (u = f), !(-1 !=
                  l && -1 != u || l >= d - 1 - u)); ++f);
              if (-1 != l && -1 != u) {
                if (u = d - 1 - u, l >= u) {
                  f = l;
    ...
    "use strict";
    angular.module("Directives")
      .directive("miniUserProfileDirective", ["$timeout", "confFactory", function() {
        return {
          restrict: "A"
    ...
    "use strict";
    angular.module("Directives")
      .directive("contactListDirective", ["$timeout", "confFactory", function() {
        return {
          restrict: "A"
    ...
    "use strict";
    angular.module("Directives")
      .directive("contactItemDirective", ["$timeout", "confFactory", function() {
        return {
          restrict: "A"
    ...
    "use strict";
    angular.module("Directives")
      .directive("contextMenuDirective", ["$timeout", "$document", "confFactory", function() {
        return {
          restrict: "A"
    ...
    "use strict";
    e.module("Directives")
      .directive("scrollGlue", ["$parse", "$timeout", function(e, o) {
        function n(e) {
          var t = e;
          return {
            getValue: function() {
    ...
    "use strict";
    angular.module("Directives")
      .directive("jplayerDirective", ["$timeout", "utilFactory", function(t, o) {
        return {
          restrict: "A"
          , link: function(n, r, a) {
            function i() {
                ...
                jQuery(r)
                  .jPlayer({
                    ready: function() {
                      jQuery(this)
                        .jPlayer("setMedia", {
                          ...
                          , poster: a.poster
                        }), a.muted !== e && jQuery(this)
                        .jPlayer("mute"), a.loop !== e && f && (jQuery(this)
                          .jPlayer("play"), c())
                    }
                    , click: function() {
                      o.browser.msie && jQuery(this)
                        .click()
                    }
                    , loadstart: function() {
                    ...
                    , loadedmetadata: function() {
                      jQuery(this)
                        .jPlayer("play"), console.log("loadedmetadata ")
                    }
                    , playing: function() {
  ...
  .directive("previewDirective", ["$document", "confFactory", "utilFactory", function(e, t, o) {
    return {
      restrict: "EA"
  ...
  .directive("mmlazyDirective", function() {
    return {
      restrict: "A"
      , link: function(e, t) {
            ...
            , performCloseDialog: function(t, o) {
              ...
              if ("undefined" != typeof M.Hammer) {
                var c = e.element(t)
                  .scope()
                  .hammerTime;
                c.off("tap", n), c.destroy && c.destroy(), delete t.scope()
                  .hammerTime
              } else t.unbind("click");
              1 === s && C.unbind("keydown"), t.hasClass("ngdialog-closing") || (s -= 1), p.$broadcast("ngDialog.closing", t), a ? t.unbind(i)
                .bind(i, function() {
                  t.scope()
                    .$destroy(), t.remove(), 0 === s && (C.removeClass("ngdialog-open"), _.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)
                })
                .addClass("ngdialog-closing") : (t.scope()
                  .$destroy(), t.remove(), 0 === s && (C.removeClass("ngdialog-open"), _.resetBodyPadding()), p.$broadcast("ngDialog.closed", t)), l[r] && (l[r].resolve({
                  id: r
                  , value: o
                  , $dialog: t
                  , remainingDialogs: s
  ...
  .directive("mmRepeat", ["$document", "$compile", "$rootScope", function(e, t) {
    ...
    function r(e, t, r, a) {
      ...
      return f > 0 ? (u = o(e, 0, 0, f, a), i = u.index, f = u.total) : (i = 0, f = 0), c = o(e, i, f, d, a)
        .index, c = c >= e.length ? e.length - 1 : c, s = n(e, 0, i, a), l = n(e, c + 1, e.length, a), {
          topHeight: s
          , bottomHeight: l
          , startIndex: i
          , endIndex: c
  ...
  .directive("mmRepeatKeyboard", ["$timeout", "utilFactory", "confFactory", function(e, t, o) {
    return {
      restrict: "A"
      , priority: 1001
      , scope: !1
  ...
  .directive("navChatDirective", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", function(e, t, o, n, r, a, i, c, s
    , l, u, f) {
    return {
      restrict: "EA"
      , scope: !0
  ...
  .directive("navContactDirective", ["$rootScope", "$timeout", "$state", "contactFactory", "stateManageService", "confFactory", "utilFactory", function(e, t, o, n, r, a, i) {
    return {
      restrict: "EA"
      , scope: !0
  ...
  .directive("mmSrc", ["$document", "$timeout", "$rootScope", function(e, t) {
    return {
      priority: 99
      , link: function(e, o, n) {
        function r() {
  ...
  .directive("mmPaste", ["$timeout", "utilFactory", "stateManageService", function(e, t, o) {
    return {
      restrict: "EA"
      , scope: {
        pasteLimit: "="
      ...
      , link: function(n, r) {
        ...
        r.on("paste", function(n) {
          ...
          return o.canDo("pasteFile") ? (t.browser.mozilla && r.clipboardData && 0 == r.clipboardData.types.length && (n.preventDefault(), n.stopImmediatePropagation()), void(s >= i ? (n.preventDefault(), n.stopImmediatePropagation()) : (a &&
            e.cancel(a), a = e(function() {
              s = 0
  ...
  .directive("contactPicker", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", "mmpop", function(e, t, o, n, r, a, i
    , c, s, l, u, f) {
    function d(e) {
        ...
        t.contactList = r(c.pickContacts(p.types, p.opt, !0)
            ...
            g && e.cancel(g), g = e(function() {
              if (t.keyword) {
                ...
                t.contactList = c.pickContacts(p.types, o, !0)
                  .result, i(!0)
              } else t.contactList = r(c.pickContacts(p.types, p.opt, !0)
                .result, h), i(!0)
            }, 200)
