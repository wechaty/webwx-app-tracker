...
, angular.module("Controllers", []), ! function() {
    ...
    "use strict";
    angular.module("Controllers")
      .controller("loginController", ["$scope", "loginFactory", "utilFactory", "reportService", function(
        e // $scope
        , t // loginFactory
        , o // utilFactory
        , n // reportService
                ...
                , g.open({
                  ...
                  , controller: ["$scope", function(e) {
                    e.contact = a
                      ...
                      , e.addUserContent = MM.context("5a97440") + y.formatHTMLToSend(c.getUserInfo()
                        .NickName)
                      , e.isShowSendBox = r || !1
                      , e.chat = function(t) {
                        o.go("chat", {
        ...
        , function(e, t, o, n, r, a, i, c, s, l, u, f, d, g, m) {
          ...
          function C(e) {
            ...
            if (window.getSelection)
              t = window.getSelection()
              , t.rangeCount > 0 && (o = t.getRangeAt(0)
                .cloneRange()
                , o.collapse(!0)
                , o.setStart(D, 0)
                , n = o.toString()
                  ...
                  .on("beforeFileQueued", function(e) {
                    if (T(e.ext)) {
                      if (e.size > 1024 * B * 1024)
                        return alert(MM.context("8c88ff6") + B + "M"), !1
                    } else if (e.size > 1024 * H * 1024)
                      return alert(MM.context("0c9c48a") + H + "M"), !1;
          ...
          $(D)
            ...
            , t.isMacOS = navigator.userAgent.toUpperCase()
            .indexOf("MAC OS") > -1
            , t.editAreaCtn = "";
          var O;
          ...
          t.pickConfig = {
            ...
            , t.add = function() {
              ...
              angular.forEach(t.selectedUsers, function(e) {
                ...
                , (l as chatroomFactory)
                .addMember(e.UserName, o.join(","), function(e) {
    ...
    "use strict";
    angular.module("Controllers")
      .controller("contextMenuController", ["$rootScope", "$scope", "$state", "contextMenuFactory", "accountFactory", "confFactory", "contactFactory", "ngDialog", "chatroomFactory", "emojiFactory", "utilFactory", "chatFactory", function(
        e // $rootScope
        , t // $scope
        , o // $state
  ...
  , angular.module("Services", []), ! function() {
    ...
    angular.module("Services")
      .factory("appFactory", ["$http", "$q", "confFactory", "accountFactory", "loginFactory", "utilFactory", "reportService", "mmHttp", function(
        e // $http
        , t // $q
        , o // confFactory
        , n // accountFactory
        ...
        var s = {
          ...
          , syncCheck: function() {
            var e = t.defer()
              , c = this
              , s = o.API_synccheck + "?" + ["r=" + a.now(), "skey=" + encodeURIComponent(n.getSkey()), "sid=" + encodeURIComponent(n.getSid()), "uin=" + n.getUin(), "deviceid=" + n.getDeviceID(), "synckey=" + encodeURIComponent(n.getFormateSyncKey())]
              .join("&");
              ...
              .done(function() {
                window.synccheck && "0" == window.synccheck.retcode ? "0" != window.synccheck.selector ? c.sync()
                  .then(function(t) {
                    ...
                    0) : (e.reject("syncCheck net error")
          ...
          , service = {
            ...
            , postEmoticonMessage: function(e) {
              ...
              e.MediaId && (t.MediaId = e.MediaId)
                , e.MMSourceMsgId && "undefined" != typeof e.MMStatus && e.MMStatus != confFactory.MSG_SEND_STATUS_SUCC && (e.MMPreviewSrc = confFactory.API_webwxgetmsgimg + "?&MsgID=" + e.MMSourceMsgId + "&skey=" + encodeURIComponent(
                  accountFactory.getSkey()) + "&type=big")
            ...
            , _appAttachMsgProcess: function(e) {
              ...
              t = utilFactory.encodeEmoji(t)
                ...
                , e.MMAppMsgDownloadUrl = confFactory.API_webwxdownloadmedia + "?sender=" + e.FromUserName + "&mediaid=" + e.MediaId + "&filename=" + encodeURIComponent(e.FileName) + "&fromuser=" + accountFactory.getUin() + "&pass_ticket=" +
                encodeURIComponent(accountFactory.getPassticket()) + "&webwx_data_ticket=" + encodeURIComponent(utilFactory.getCookie("webwx_data_ticket"))
            }
    ...
    "use strict";
    angular.module("Services")
      .factory("chatroomFactory", ["$rootScope", "$timeout", "$http", "$q", "contactFactory", "accountFactory", "emojiFactory", "confFactory", "utilFactory", "reportService", "mmHttp", function(
        e // $rootScope
        , t // $timeout
        , o // $http
        , n // $q
        ...
        var n, r, a, i = {}
          ...
          , f = {
            ...
            , getFormateSyncKey: function() {
              for (var e = this.getSyncKey()
                  .List, t = [], o = 0, n = e.length; n > o; o++)
    ...
    "use strict";
    angular.module("Services")
      .factory("contactFactory", ["$rootScope", "$http", "$q", "$timeout", "confFactory", "accountFactory", "emojiFactory", "utilFactory", "resourceService", "reportService", "mmHttp", function(
        e // $rootScope
        , t // $http
        , o // $q
        , n // $timeout
          ...
          , P = {
            ...
            , canSearch: function(e) {
              ...
              return c = t.toUpperCase()
                ...
                , s = o.toUpperCase()
                .indexOf(e)
                , c >= 0 || s >= 0 ? !0 : (c = n.toUpperCase()
                  .indexOf(e)
                  , s = r.toUpperCase()
                  .indexOf(e)
                  , c >= 0 || s >= 0 ? !0 : a.toUpperCase()
            ...
            , addBatchgetContact: function(e, t, r) {
              function i(e) {
                f.resolve(e.ContactList)
                  ...
                  , w = [], !w.length && v.length > 0 && d.batchGetContact()
                  .then(i, s)
              }
              ...
              function s(e) {
                ...
                w = []
                  ...
                  , w.length || !v.length && !S.length || d.batchGetContact()
                  .then(i, s)
              }
              var l, u, f = o.defer()
                , d = this;
    ...
    "use strict";
    angular.module("Services")
      .factory("loginFactory", ["$http", "$q", "$timeout", "accountFactory", "confFactory", "utilFactory", "mmHttp", "reportService", function(
        e // $http
        , t // $q
        , o // $timeout
        , n // accountFactory
    ...
    "use strict";
    angular.module("Services")
      .factory("utilFactory", ["$q", "$rootScope", "confFactory", function(
        e // $q
        , t // $rootScope
        , o // $confFactory
      ) {
          ...
          , hrefEncode: function(e) {
            ...
            if (o) {
              for (var n, r, a = 0, c = o.length; c > a; ++a)
                n = /&lt;a href=(?:'|")(.*?)(?:'|").*?&gt;.*?&lt;\/a&gt;/.exec(o[a])
                , n && n[1] && (r = n[1]
                  , t.isUrl(r) && (e = e.replace(n[0], this.htmlDecode(n[0]))
      ...
      .factory("titleRemind", ["$window", function(e) {
        function t(e, t) {
          ...
          "undefined" != typeof n.hidden ? (r = "hidden"
            ...
            , "undefined" == typeof n.addEventListener || "undefined" == typeof r ? ($(window)
              .focus(function() {
                t()
              })
              , $(window)
          ...
          var _ = {
            ...
            , v = {
              open: function(a) {
                ...
                return g.when(c(w.template || w.templateUrl))
                  .then(function(t) {
                    ...
                    if (w.className && b.addClass(w.className)
                      ...
                      , w.preCloseCallback) {
                      var c;
                      e.isFunction(w.preCloseCallback) ? c = w.preCloseCallback : e.isString(w.preCloseCallback) && E && (e.isFunction(E[w.preCloseCallback]) ? c = E[w.preCloseCallback] : E.$parent && e.isFunction(E.$parent[w.preCloseCallback]) ?
                          c = E.$parent[w.preCloseCallback] : p && e.isFunction(p[w.preCloseCallback]) && (c = p[w.preCloseCallback]))
                    ...
                    if (E.closeThisDialog = function(e) {
                      ...
                      , n = function(e) {
                        var t = w.closeByDocument ? o(e.target)
  ...
  .directive("mmRepeat", ["$document", "$compile", "$rootScope", function(e, t) {
    ...
    function a(e, t, o, n) {
      ...
      e.bottomHeight = i.bottomHeight
        ...
        , o.length = 0
        , a = n.slice(i.startIndex, i.endIndex + 1), [].push.apply(o, a)
  ...
  , angular.module("Directives")
  .directive("navChatDirective", ["$timeout", "$log", "$document", "$stateParams", "$rootScope", "chatFactory", "accountFactory", "contactFactory", "appFactory", "confFactory", "utilFactory", "stateManageService", function(
    e // $timeout
    , t // $log
    , o // $document
    , n // $stateParams
    ...
    , function(e, t, o, n, r, a, i, c, s, l, u, f, d, g) {
      function m(e) {
        for (var t, o = [], n = 0; n < e.length; n++)
          t = e[n]
          , o.push(t), [].push.apply(o, t.MPArticleList);
        return o
      }
      return {
        restrict: "EA"
          ...
          e.subscribeMsgs = []
            ...
            , e.$watch(function() {
              ...
              0 != t && (e.subscribeMsgs = g.getSubscribeMsgs()
                , e.articleList = m(e.subscribeMsgs), !e.currentItem && e.subscribeMsgs.length > 0 && (g.current = e.currentItem = e.subscribeMsgs[0].MPArticleList[0]
      ...
      , link: function(t, o) {
        ...
        t.contactList = r(c.pickContacts(p.types, p.opt, !0)
          ...
          , t.toggleUser = function(e) {
            ...
            t.keyword && (t.keyword = ""
              , t.current = void 0
              , t.search()), -1 == o ? t.selectList.push(e) : t.selectList.splice(o, 1)
          }
          ...
          , $(document)
          .on("keydown", "body", t.searchKeydown)
